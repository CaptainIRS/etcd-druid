...
func (b *stsBuilder) createStatefulSetSpec(ctx component.OperatorContext) error {
	...
	b.sts.Spec.Replicas = ptr.To(utils.IfConditionOr[int32](druidv1alpha1.IsPodManagementEnabled(b.etcd.ObjectMeta), b.replicas, 0))
	...
	if !b.skipSetOrUpdateForbiddenFields {
		...
		if druidv1alpha1.IsPodManagementEnabled(b.etcd.ObjectMeta) {
...
func (b *stsBuilder) getBackupRestoreContainer() (corev1.Container, error) {
	env, err := utils.GetBackupRestoreContainerEnvVars(b.etcd.ObjectMeta, b.etcd.Spec.Backup.Store)
	if err != nil {
